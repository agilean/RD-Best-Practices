...
![](/Users/zhangye/Desktop/API设计最佳实践/overview.png)

4个等级分别是：

![](/Users/zhangye/Desktop/API设计最佳实践/level0.png)
第一级（Level 0）的 Web 服务只是使用 HTTP 作为传输方式，实际上只是远程方法调用（RPC）的一种具体形式。SOAP 和 XML-RPC 都属于此类。

![](/Users/zhangye/Desktop/API设计最佳实践/level1.png)
第二级（Level 1）的 Web 服务引入了资源的概念。每个资源有对应的标识符和表达。

![](/Users/zhangye/Desktop/API设计最佳实践/level2.png)
第三级（Level 2）的 Web 服务使用不同的 HTTP 方法来进行不同的操作，并且使用 HTTP 状态码来表示不同的结果。如 HTTP GET 方法来获取资源，HTTP DELETE 方法来删除资源。

![](/Users/zhangye/Desktop/API设计最佳实践/level3.png)
